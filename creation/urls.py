...
urlpatterns = patterns('',
    ...
    url(r'^view/component/(\d+)/(\w+)/$', 'creation.views.view_component', name="view_component"),
    ...
    url(r'payment/challan/$','creation.views.list_payment_challan', name="payment-challan-list"),
)
